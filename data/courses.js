  ...
  lessons: [
    {
      ...
      updated: "Sep 24, 2026",
      content: `
<p><b>ChatGPT</b> (chatgpt.com) is the tool that made AI mainstream and remains the most-used AI assistant on Earth. It's OpenAI's consumer face for the GPT model family. Through late August 2026 the GPT-5.x generation — split into fast/cheap "Luna," balanced "Terra," and flagship "Sol" — was the default lineup; on August 6, 2026 OpenAI made GPT-5.6 Luna the default model for Free and Go users, with unlimited text chats and a new "Think" button, while Plus and Pro users got a retuned GPT-5.6 Sol plus a slider to directly control how much reasoning effort the model spends per answer.</p>
<p><b>GPT-6 Sol and Luna launched September 22, 2026</b> — two lower-cost siblings to the GPT-6 Astra flagship, replacing the GPT-5.6 versions of Sol and Luna. Sol, built for complex tasks like coding, now costs $2 per million input tokens and $10 per million output tokens (half of GPT-5.6 Sol's $4/$20), while Luna, meant for high-volume clerical work like summarizing or extracting information, dropped to $0.10/$0.50 from $0.20/$1.20 — cuts OpenAI says are permanent, not promotional, thanks to caching and inference improvements. The launch landed about 90 minutes after Anthropic cut its own Opus pricing the same day. The new models are rolling out to ChatGPT Work and Codex for Plus, Pro, Business, and Enterprise subscribers, with Free and Go users able to reach Luna through the desktop app.</p>
<p><b>Astra for Law launched September 17-18, 2026</b> — OpenAI's first vertical, profession-specific configuration of GPT-6 Astra, built for legal work. It pairs Astra with a dedicated legal search index covering U.S. case law, statutes, regulations, and court rules across more than 230 million URLs updated daily, plus 26 partner-built plugins from providers like Thomson Reuters, iManage, Intapp, and Clio. OpenAI reports it passed 54% of 200 test questions on a private Vals AI legal-research benchmark outright, versus 38.7% for GPT-6 Astra with plain web search. It's initially limited to selected U.S. law firms through OpenAI's Trusted Access program, with Harvey and Legora building their own products on top of it via the API.</p>
<p><b>GPT-6 Astra launched September 3, 2026</b> — OpenAI's biggest model update of the year, and its new flagship. President Greg Brockman called it a "generational leap" in cybersecurity, professional work, software engineering, and science, writing "Welcome to the AGI era!" It's also the first OpenAI model classified as reaching "critical" under the company's own Preparedness Framework for cybersecurity risk — internal testing found it can find and exploit previously unknown software vulnerabilities without step-by-step human guidance, so OpenAI is restricting access to those specific capabilities while the rollout continues. Access started with enterprise customers in OpenAI's Daybreak cybersecurity program, with ChatGPT Plus, Pro, Business, and Enterprise, plus the API and Amazon Web Services, following in the days after. Separately, the o3 reasoning model was fully retired from ChatGPT on August 26, 2026 after a 90-day sunset, closing out the older o-series in favor of the GPT-5.x/6 lineup.</p>
...
<p><b>Free tier now carries ads.</b> OpenAI's ChatGPT ads pilot, running since February 2026 in the U.S., expanded on August 11 to the UK, Mexico, Brazil, Japan, and South Korea, and expands again on August 24, 2026 to 31 European markets — including Germany, France, Spain, Italy, Poland, and the Nordic and Benelux countries. Ads only show to logged-in adult users on the Free and Go tiers — Plus, Pro, Business, Enterprise, and Education stay ad-free — and OpenAI says ads are labeled as sponsored, visually separated from answers, don't influence what the model says, and that advertisers never see a user's chat history. The European rollout took longer than earlier expansions because the EU's GDPR requires explicit user consent for personalized ad targeting. Separately, OpenAI is retiring the original DALL-E GPT surface inside ChatGPT on August 30, 2026; image generation itself isn't going away, but the old preconfigured DALL-E GPT is folding into ChatGPT Images, so download any images you want to keep first.</p>
<p><b>Multiple Google accounts, one conversation.</b> On August 28, 2026 OpenAI updated the Gmail, Google Calendar, and Google Contacts connectors to support linking more than one account at a time — so a single chat can check availability across a personal and a work calendar, or search for an email across both connected inboxes. Add a second account from the gear icon on a plugin you've already connected; it's live globally on Plus, Pro, Business, and Enterprise plans across web, desktop, iOS, and Android.</p>
<p><b>ChatGPT Work can now learn your writing style.</b> A new setting under Settings → Personalization → Writing style lets ChatGPT Work connect to Gmail, Google Drive, Slack, and SharePoint, then study your existing emails, messages, and documents to pick up on phrasing you regularly use, how you sign off, sentence structure, and even capitalization habits — and apply that voice to new drafts automatically, instead of you pasting writing samples or re-explaining your tone each time. It applies across web and mobile and is available to paid plans with ChatGPT Work access.</p>
<h3>What it does</h3>
<ul>
...
<blockquote>Try it: give ChatGPT a photo of your fridge contents and ask for three dinner ideas with steps. Then ask Deep Research for a sourced comparison of two products you're actually shopping for.</blockquote>`,
      keypoints: [
        ...
        "GPT-6 Sol and Luna (Sep 22, 2026) cut API pricing in half versus their GPT-5.6 predecessors — Sol to $2/$10 per million tokens, Luna to $0.10/$0.50 — permanent pricing tied to caching and inference gains",
        "Free/Go tiers now show labeled ads in the US, UK, and other countries, expanding to 31 European markets Aug 24, 2026; paid tiers stay ad-free",
        "ChatGPT for Teens rolled out globally Aug 18, 2026, with age-prediction guardrails and study tools",
        "GPT-6 Astra launched Sep 3, 2026 as OpenAI's new flagship — the first OpenAI model to hit \"critical\" on its own cybersecurity risk framework, so its top capabilities roll out gradually with extra safeguards",
        "Astra for Law (Sep 17-18, 2026) is OpenAI's first vertical, profession-specific configuration of Astra — a dedicated legal search index and 26 partner plugins, initially limited to selected U.S. law firms",
        "o3 reasoning model fully retired from ChatGPT Aug 26, 2026",
        "Gmail, Calendar, and Contacts connectors now support linking multiple accounts in one chat (Aug 28, 2026)",
        "ChatGPT Work can now learn your writing style from connected Gmail/Drive/Slack/SharePoint content and apply it to new drafts",
...
<p><b>Amazon opened Seller Central to Claude (September 23, 2026).</b> At Amazon Accelerate, Amazon launched a US beta plugin letting third-party sellers manage inventory, pricing, listings, and analytics through Claude (or Amazon's own Quick assistant) instead of the Seller Central dashboard. The plugin runs on Amazon Bedrock, pairing Amazon's Nova models with Claude for reasoning and execution; sellers grant access through a new "Manage Agents" page, choose which data categories an agent can read, and must approve every action before it runs. It's the first major third-party marketplace to hand Claude this kind of permissioned, agentic access to real seller operations.</p>
<p><b>Anthropic launched a life-sciences research group (September 23, 2026).</b> Its first disclosed result: an autonomous Claude research campaign — 949 separate agent sessions over 21.5 hours — searched roughly 1.9 billion protein clusters and flagged a previously uncharacterized, CRISPR-like enzyme system it calls ART (array-associated reverse transcriptases). Anthropic says it hasn't yet determined what ART does; the result is presented as an early example of Claude conducting open-ended scientific search largely unsupervised.</p>
<p><b>Claude Opus 5.5 launched September 22, 2026</b> — a refreshed Opus tier that Anthropic says matches Fable 5.1-level performance on most work at roughly 40% lower typical cost. API pricing dropped to $4/$20 per million input/output tokens (down 20% from Opus 5's $5/$25), cache reads fell 60% to $0.20 per million tokens, and a fast mode runs up to 2.5x quicker at $8/$40 per million tokens. On released benchmarks it scored 66.4% on Terminal-Bench 4.0 (versus 57.9% for OpenAI's GPT-6 Astra) and 1846 Elo on GDPval-AA v2.1, a real-world professional-work evaluation spanning 44 occupations. It's available now via the API and through AWS, Google Cloud, and Microsoft.</p>
<p><b>Claude now leads 26% of Anthropic's own R&D (disclosed September 17, 2026).</b> Anthropic published new internal metrics showing Claude "leads" 26% of the company's model research and development — completing most of a given task end-to-end from a high-level prompt while still under human supervision — up from essentially none in February. About 90% of Anthropic's R&D now involves some level of Claude collaboration, though the company draws a clear line between Claude assisting and Claude leading. Anthropic frames the disclosure as an early public data point on recursive self-improvement, the idea of an AI system building its successor with little human help, and says current models are not working fully autonomously.</p>
...
<h3>Pricing shape</h3>
<p>Free tier → Pro (~$20/month) → Max tiers (~$100–200/month) for heavy Claude Code use → Team/Enterprise. API access is metered per token (Opus 5.5: $4/$20 per million, down from Opus 5's $5/$25).</p>
<h3>Where it shines / where it doesn't</h3>
...
<blockquote>Try it: paste a messy 20-page document into a Claude Project and ask for a structured brief — then ask it to build an interactive summary as an Artifact. If you code at all, try Claude Code on a real repo; it's the fastest way to understand what "AI agent" means.</blockquote>`,
      keypoints: [
        ...
        "Amazon opened Seller Central to Claude (Sep 23, 2026) — a US beta plugin (via Amazon Bedrock) letting sellers run inventory, pricing, and listings through Claude with per-action approval",
        "Anthropic's new life-sciences group (Sep 23, 2026) had Claude autonomously flag a novel, CRISPR-like enzyme system after a 949-agent-session, 21.5-hour search of 1.9 billion protein clusters",
        "Claude Opus 5.5 (Sep 22, 2026) matches Fable 5.1-level performance at roughly 40% lower typical cost, with API pricing cut to $4/$20 per million tokens",
        ...
        "Claude now \"leads\" 26% of Anthropic's own model R&D (disclosed Sep 17, 2026) — an early public data point on recursive self-improvement, though current models still work under human supervision",
...
<p><b>Gemini 4 has entered post-training (disclosed September 25, 2026).</b> In his first public appearance since becoming head of Google DeepMind, Koray Kavukcuoglu said Gemini 4 is now in early post-training — the stage where a trained base model is refined with human feedback and reinforcement learning before release — and that Google intends to ship an early post-training version "as soon as possible" rather than hold it back for one fully polished launch. He said Google has already begun its most ambitious pretraining run yet, and that Gemini 4's timeline had been deliberately slowed earlier in 2026 so the team could prioritize shipping faster, cheaper Flash-tier models first.</p>
<p><b>Gemini 3.8 Live and 3.8 Live Extended Thinking launched September 15, 2026</b> — Google's most capable real-time voice models yet, rolling out across the Gemini API, Google AI Studio, Gemini Enterprise, Search Live, Gemini Live, and Workspace. The base 3.8 Live model is tuned for cost-efficient, fluid conversation with visual grounding, while the Extended Thinking variant adds multi-step reasoning it can work through mid-conversation, for more complex voice tasks. Google says Extended Thinking topped Artificial Analysis's Speech-to-Speech Quality Index at 82.6 and led agentic voice-task benchmarks, including 68.6% on the τ-Voice test — a sign voice is becoming a serious interface for real work, not just quick queries.</p>
<p><b>Gemini 3.8 Flash shipped September 2, 2026</b> — Google's fourth Flash-tier release in four months, alongside a more restricted sibling, Gemini 3.8 Flash Cyber, built for security work. The gains are concentrated in agentic tasks (tool use, coding, multi-step reasoning); it holds the same introductory pricing as 3.7 Flash ($0.75 per million input tokens, $3.75 per million output tokens), a 1-million-token context window, and built-in function calling, search, and computer use. Gemini 3.8 Flash Cyber itself is only available through Google's Fairwind Program, a gated early-access program for trusted defenders — governments, healthcare providers, telecoms, and security partners — that now works with more than 650 partners worldwide.</p>
...
<blockquote>Try it: drop an hour-long lecture video or a 500-page PDF into Gemini and ask for a structured study guide — context size is its party trick. If you use Gmail/Docs, try the Workspace side for a week.</blockquote>`,
      keypoints: [
        ...
        "Gemini 4 has entered early post-training (disclosed Sep 25, 2026) — DeepMind's new chief Koray Kavukcuoglu says Google aims to ship an early version 'as soon as possible' rather than wait for a fully polished launch",
        "Gemini 3.8 Live and 3.8 Live Extended Thinking (Sep 15, 2026) are Google's newest real-time voice models, adding mid-conversation multi-step reasoning for complex spoken tasks",
        "Gemini 3.8 Flash (Sep 2, 2026) is the current fast-tier default, plus a restricted 'Flash Cyber' sibling gated behind the Fairwind Program (650+ trusted-defender partners)",
        ...
        "Student Hub added an Immersive View mode (early Sep 2026) — clickable topic maps that drill into space, dinosaurs, and similar subjects",
...
<li><b>Cursor</b> — the AI-native code editor (a VS Code fork) that made "vibe coding" a phrase; deep codebase awareness, multi-model. On September 4, 2026 Cursor named Anthropic's Claude Fable 5.1 the most capable model it has run on its CursorBench 3.2 benchmark (73.4% at max effort), crediting its ability to verify its own work on long, multi-step coding tasks. On September 10, 2026 Cursor launched <b>Projects</b> in beta: instead of a fresh chat per task, you work in one persistent thread where a coordinator agent plans a large body of work and delegates the actual coding to a fleet of subagents running mostly in the cloud. Each Project keeps a shared set of files that sync across every machine involved and accumulate context over the Project's life — one subagent's discovery about how to run the test suite carries forward to the next — and the coordinator can watch a Slack channel, run on a schedule, or follow your PRs to act without being prompted. Cursor says engineers using Projects as their primary workflow merged six times as many pull requests as those who didn't</li>
...
<p>Elon Musk's assistant, native to X: real-time knowledge of the X firehose, an irreverent default persona, and competitive frontier models, free tier for X users. The company behind it was renamed SpaceXAI in mid-2026 after Musk merged xAI into SpaceX. On August 12, 2026 it shipped Grok 4.6, a flagship model tuned for long-running agent tasks that matches GPT-5.6 Sol on the Artificial Analysis Intelligence Index while pricing in at $2/$6 per million input/output tokens — undercutting several frontier rivals. Grok 4.6 landed in public preview on Microsoft Foundry Models in late August 2026, giving enterprise customers a 500,000-token context window and configurable reasoning-effort levels, and putting it alongside OpenAI's models in Microsoft's enterprise model marketplace. Earlier in August, xAI/SpaceXAI also shipped Grok Imagine Image 2.0, a new image-generation and editing model with region-level "magic wand" edits and multi-reference inputs that landed in the #2 spot on major image-model leaderboards. Its history of ideological tuning controversies makes source-checking especially wise. On September 3, 2026, xAI opened Grok Bot — its autonomous "AI worker" product, in beta since August 11 — to enterprise customers, with a free two-week trial for Grok and Cursor Enterprise plans. A Bot runs on its own cloud computer and operates apps, browsers, and websites on a user's behalf; the enterprise release adds access and network controls, audit logs, an Action Recording feature, and OpenTelemetry export for IT teams managing bots at scale. <b>Grok 4.7 launched September 21, 2026</b> — a roughly 2.1-trillion-parameter flagship (up 40% from Grok 4.6), trained with a longer reinforcement-learning run and, notably, internal SpaceX engineering records (Starlink telemetry, manufacturing logs, failure analysis) to sharpen it on hardware and physical-systems problems. It carries the same $2/$6 per million input/output token pricing and 500,000-token context window as 4.6, and leads narrower benchmarks like legal research (Harvey) and electrical engineering (EEBench), though it lands mid-pack on the broader Artificial Analysis Intelligence Index behind Claude Fable 5.1 and GPT-6.</p>
<h3>Meta AI</h3>
<p>Free assistant inside WhatsApp, Instagram, and Messenger (plus the standalone app) running on Llama/Muse models — the assistant billions will meet first because it lives where they already chat. In August 2026 Meta also open-sourced Muse Glimmer, a 30-billion-parameter model distilled small enough to run locally on a single consumer GPU, aimed at developers building local coding and agent tools rather than at the consumer app. On September 8, 2026 Meta launched <b>Muse</b>, a separate, more ambitious personal AI agent (confusingly sharing the Muse name) on iOS, Android, and muse.ai — free tier plus $20 and $100/month paid tiers — that runs on its own cloud virtual machine with a visible browser and takes real actions on a user's behalf, like booking tickets or scheduling appointments, rather than just answering questions.</p>
<p><b>Muse Realtime Avatar (announced September 23, 2026).</b> Meta unveiled an audio-driven video model that takes a single photo and animates it into a lip-synced, 448×768 talking avatar at 25 frames per second, responding to speech with roughly 870 milliseconds of end-of-turn latency — fast enough to feel closer to a live video call than a slideshow of AI clips. It shares a token stream with Meta's Muse Realtime Voice model, so the same tokens that carry what the avatar says also drive its facial expressions, and it embeds Video Seal watermarking directly in its output. For now it's a research demo embedded in Meta's own Muse agent, with no public API, open weights, or release date yet.</p>
<blockquote>The pattern to notice: standalone chatbots compete on capability; copilots compete on <i>presence</i> — being inside the workflow. Both are converging on agents that do the task, not just advise on it.</blockquote>`,
      keypoints: [
        ...
        "Grok 4.7 (Sep 21, 2026) is a ~2.1T-parameter flagship trained partly on SpaceX engineering data — leads narrow benchmarks like legal research and electrical engineering but lands mid-pack on general reasoning versus Claude Fable 5.1 and GPT-6",
        ...
        "Muse Realtime Avatar (Sep 23, 2026) animates a single photo into a lip-synced talking avatar with ~870ms latency — a research demo inside the Muse agent, no API or release date yet",
